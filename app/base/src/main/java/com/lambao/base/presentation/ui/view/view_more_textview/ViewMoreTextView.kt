package com.lambao.base.presentation.ui.view.view_more_textview
...
class ViewMoreTextView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.ViewMoreTextView) {
            visibleLines = this.getInt(R.styleable.ViewMoreTextView_visibleLines, 0)
            isExpanded = this.getBoolean(R.styleable.ViewMoreTextView_isExpanded, false)
            animationDuration = this.getInt(R.styleable.ViewMoreTextView_duration, 1000)
            foregroundColor =
                this.getColor(R.styleable.ViewMoreTextView_foregroundColor, Color.TRANSPARENT)
            ellipsizeText = this.getString(R.styleable.ViewMoreTextView_ellipsizeText)
            isUnderlined = this.getBoolean(R.styleable.ViewMoreTextView_isUnderlined, false)
            ellipsizeTextColor =
                this.getColor(R.styleable.ViewMoreTextView_ellipsizeTextColor, Color.BLUE)
        }
    }
